...
def deconvolution(realX_u,realX_d,fakeX_new,d):
    ...
    for i in range(realX_u.shape[2]):
        for k in range(realX_u.shape[2]):
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF_u{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), IRF_u['IRF_u_%d' % i][:,:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF_s{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), IRF_s['IRF_s_%d' % i][:,:,k], delimiter=",")
    ...
    #     plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF{:>d} Floor_real_{:>d}.png'.format(d,i),bbox_inches = 'tight')
    #     plt.close()
    ...
    #     fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
    #     fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
    #     plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF{:>d} Floor_switch_{:>d}.png'.format(d,i),bbox_inches = 'tight')
    #     plt.close()
    ...
    for q in range(10):
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF{:>d}_undamaged_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF{:>d}_switched_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/IRF{:>d}_comparison_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
    ...
    for i in range(realX_u.shape[2]):
        for k in range(realX_u.shape[2]):
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/dv_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), dv['dv_%d' % i][:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/cc_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), cc['cc_%d' % i][:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/error_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), error['error_%d' % i][:,k], delimiter=",")
    ...
    for i in range(realX_u.shape[2]):
        ...
        fig.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/stretching_{:>d}_{:>d}.png'.format(d,i), dpi=100)
        plt.close(fig)
