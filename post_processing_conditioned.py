...
checkpoint_dir = "./checkpoint_c/13_04"
...
def PlotLoss(history):
    ...
    plt.savefig('./results_c/loss.png',format='png',bbox_inches = 'tight')
    #plt.savefig('./results_c/loss.eps',format='eps',rasterized=True,bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.savefig('./results_c/D_x.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/D_x.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_c/D_c.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/D_c.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_c/D_s.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/D_s.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_c/D_n.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/D_n.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
...
def PlotReconstructedTHs(model,realXC):
    ...
    for j in range(realX.shape[2]):
        for k in range(10):
            ...
            hax.tick_params(axis='both', labelsize=18)
            plt.savefig('./results_c/reconstruction_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/reconstruction_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('./results_c/fft_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            # #plt.savefig('./results_c/fft_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
...
def PlotSwitchedTHs(model,real_u,real_d,d):
    ...
    if d==1:
        ...
        for j in range(realX_u.shape[2]):
            for k in range(10):
                ...
                #hax.set_ylim([-1.0, 1.0])
                hax.tick_params(axis='both', labelsize=18)
                plt.savefig('./results_c/reconstruction0_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
                #plt.savefig('./results_c/reconstruction0_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
                plt.close()
                ...
                # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
                # hax.tick_params(axis='both', labelsize=18)
                # plt.savefig('./results_c/fft0_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
                # #plt.savefig('./results_c/fft0_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
                # plt.close()
    ...
    for j in range(realX_d.shape[2]):
        for k in range(10):
            ...
            #hax.set_ylim([-1.0, 1.0])
            hax.tick_params(axis='both', labelsize=18)
            plt.savefig('./results_c/reconstruction{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/reconstruction{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('./results_c/fft{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            # #plt.savefig('./results_c/fft{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
    ...
    for j in range(realX_u.shape[2]):
        for k in range(10):
            ...
            plt.savefig('./results_c/reconstruction_switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/reconstruction_switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('./results_c/fft_switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            # #plt.savefig('./results_c/fft_switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
            ...
            plt.savefig('./results_c/switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            plt.savefig('./results_c/cross-corr{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/cross-corr{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            plt.savefig('./results_c/cross-corr-comparison{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/cross-corr-comparison{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
...
def PlotTHSGoFs(model,realXC):
    ...
    for j in range(realX.shape[2]):
        for k in range(10):
            ...
            plt.savefig('./results_c/gof_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            #plt.savefig('./results_c/gof_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
...
def PlotEGPGgrid(col_x,col_y,col_k,i,df,k_is_color=False, scatter_alpha=.7):
    ...
    plt.savefig('./results_c/Gz(Fx(X))_gofs_{:>d}.png'.format(i),bbox_inches = 'tight')
    #plt.savefig('./results_c/Gz(Fx(X))_gofs_{:>d}.eps'.format(i),bbox_inches = 'tight',dpi=200)
    plt.close()
...
def PlotBatchGoFs(model,Xtrn,Xvld,i):
    ...
    egpg_df.to_csv('./results_c/EG_PG_{:>d}.csv'.format(i), index= True)
...
def PlotClassificationMetrics(model,realXC):
    ...
    df.to_csv('./results_c/Classification Report C.csv', index= True)
    ...
    plt.savefig('./results_c/classification_report_fakeC.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/classification_report.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.savefig('./results_c/confusion_matrix_fakeC.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/confusion_matrixC.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    report = classification_report(y_true = labels_real, y_pred = labels_rec,
            target_names=target_names,output_dict=True,zero_division=1)
    df = pd.DataFrame(report).transpose()
    df.to_csv('./results_c/Classification Report recC.csv', index= True)
    cr = sn.heatmap(pd.DataFrame(report).iloc[:-1, :].T, annot=True, vmin=0, vmax=1, annot_kws={"size": 12})
    cr.tick_params(axis='both', labelsize=12)
    cr.set_yticklabels(cr.get_yticklabels(), rotation=0)
    plt.savefig('./results_c/classification_report_recC.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/classification_reportrec.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.ylabel("True class",fontsize=22,labelpad=10)
    plt.xlabel("Predicted class",fontsize=22,labelpad=10)
    plt.savefig('./results_c/confusion_matrix_recC.png',bbox_inches = 'tight')
    #plt.savefig('./results_c/confusion_matrixrecC.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
...
def PlotLatentSpace(model,realXC):
    ...
    fig.savefig('./results_c/s_all.png')
    ...
    for n_i in range(1):
        ...
        fig.savefig('./results_c/n_{:>d}_{:>d}'.format(n_i,n_i+1),dpi=300,bbox_inches = 'tight')
        plt.clf()
    ...
    for s_i in range(1):
        ...
        fig.savefig('./results_c/s_{:>d}_{:>d}'.format(s_i,s_i+1),dpi=300,bbox_inches = 'tight')
        plt.clf()
...
def PlotTSNE(model,realXC):
    ...
    plt.savefig('./results_c/tsne_N.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('./results_c/tsne_S.png',bbox_inches = 'tight')
    plt.close()
...
def PlotChangeS(model,realXC):
    ...
    report = classification_report(y_true = labels_real, y_pred = labels_rec,
            target_names=target_names,output_dict=True,zero_division=1)
    df = pd.DataFrame(report).transpose()
    df.to_csv('./results_c/ChangeS_ClassificationC.csv', index= True)
    cr = sn.heatmap(pd.DataFrame(report).iloc[:-1, :].T, annot=True, vmin=0, vmax=1, annot_kws={"size": 12})
    cr.tick_params(axis='both', labelsize=12)
    cr.set_yticklabels(cr.get_yticklabels(), rotation=0)
    plt.savefig('./results_c/ChangeS_ClassificationC.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.ylabel("True class",fontsize=22,labelpad=10)
    plt.xlabel("Predicted class",fontsize=22,labelpad=10)
    plt.savefig('./results_c/ChangeS_ConfusionC.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('./results_c/ChangeS_tsne_N.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('./results_c/ChangeS_tsne_S.png',bbox_inches = 'tight')
    plt.close()
...
def PlotDistributions(model,realXC):
    ...
    for i in range(realS.shape[1]):
        ...
        plt.ylabel("Density")
        plt.savefig('./results_c/distribution_S_{:>d}.png'.format(i),bbox_inches = 'tight')
        plt.close()
    ...
    for i in range(realN.shape[1]):
        ...
        plt.ylabel("Density")
        plt.savefig('./results_c/distribution_N_{:>d}.png'.format(i),bbox_inches = 'tight')
        plt.close()
...
GiorgiaGAN.Fx = keras.models.load_model("./checkpoint_c/13_04/Fx_c",compile=False)
GiorgiaGAN.Gz = keras.models.load_model("./checkpoint_c/13_04/Gz_c",compile=False)
GiorgiaGAN.Dx = keras.models.load_model("./checkpoint_c/13_04/Dx_c",compile=False)
GiorgiaGAN.Ds = keras.models.load_model("./checkpoint_c/13_04/Ds_c",compile=False)
GiorgiaGAN.Dn = keras.models.load_model("./checkpoint_c/13_04/Dn_c",compile=False)
GiorgiaGAN.Dc = keras.models.load_model("./checkpoint_c/13_04/Dc_c",compile=False)
GiorgiaGAN.Q  = keras.models.load_model("./checkpoint_c/13_04/Q_c",compile=False)
GiorgiaGAN.Gq = keras.models.load_model("./checkpoint_c/13_04/Gq_c",compile=False)
GiorgiaGAN.h0 = keras.models.load_model("./checkpoint_c/13_04/h0_c",compile=False)
GiorgiaGAN.h1 = keras.models.load_model("./checkpoint_c/13_04/h1_c",compile=False)
GiorgiaGAN.h2 = keras.models.load_model("./checkpoint_c/13_04/h2_c",compile=False)
GiorgiaGAN.h3 = keras.models.load_model("./checkpoint_c/13_04/h3_c",compile=False)
