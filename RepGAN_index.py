...
checkpoint_dir = "./checkpoint_skip/28_04"
...
class RepGAN(Model):
    ...
    def DumpModels(self):
        self.Fx.save("./checkpoint_skip/28_04/Fx",save_format="tf")
        self.Gz.save("./checkpoint_skip/28_04/Gz",save_format="tf")
        self.Dx.save("./checkpoint_skip/28_04/Dx",save_format="tf")
        self.Ds.save("./checkpoint_skip/28_04/Ds",save_format="tf")
        self.Dn.save("./checkpoint_skip/28_04/Dn",save_format="tf")
        self.Dc.save("./checkpoint_skip/28_04/Dc",save_format="tf")
        self.Q.save("./checkpoint_skip/28_04/Q",save_format="tf")
        self.Gq.save("./checkpoint_skip/28_04/Gq",save_format="tf")
        return
