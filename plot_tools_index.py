...
def PlotLoss(history):
    ...
    plt.savefig('./results_index/loss.png',format='png',bbox_inches = 'tight')
    #plt.savefig('./results_index/loss.eps',format='eps',rasterized=True,bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.savefig('./results_index/D_x.png',bbox_inches = 'tight')
    #plt.savefig('./results_index/D_x.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_index/D_c.png',bbox_inches = 'tight')
    #plt.savefig('./results_index/D_c.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_index/D_s.png',bbox_inches = 'tight')
    #plt.savefig('./results_index/D_s.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    hax.legend(loc='best',frameon=False,fontsize=20)
    hax.tick_params(axis='both', labelsize=18)
    plt.savefig('./results_index/D_n.png',bbox_inches = 'tight')
    #plt.savefig('./results_index/D_n.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
