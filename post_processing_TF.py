...
from prova import RepGAN, ParseOptions, WassersteinDiscriminatorLoss, WassersteinGeneratorLoss, GaussianNLL
...
checkpoint_dir = "/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04"

from interferometry_TF import *
...
def PlotReconstructedTHs(model,realXC):
    ...
    for j in range(realX.shape[2]):
        for k in range(10):
            ...
            hax.tick_params(axis='both', labelsize=18)
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            # #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
...
def PlotSwitchedTHs(model,real_u,real_d,d):
    ...
    if d==1:
        ...
        for j in range(realX_u.shape[2]):
            for k in range(10):
                ...
                #hax.set_ylim([-1.0, 1.0])
                hax.tick_params(axis='both', labelsize=18)
                plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction0_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
                #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction0_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
                plt.close()
                ...
                # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
                # hax.tick_params(axis='both', labelsize=18)
                # plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft0_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
                # #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft0_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
                # plt.close()
    ...
    for j in range(realX_d.shape[2]):
        for k in range(10):
            ...
            #hax.set_ylim([-1.0, 1.0])
            hax.tick_params(axis='both', labelsize=18)
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.legend([r'$X$', r"$G_z(F_x(x))$"], loc='best',frameon=False,fontsize=20)
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            # #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
    ...
    for j in range(realX_d.shape[2]):
        for k in range(10):
            ...
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction_switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/reconstruction_switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            # hax.tick_params(axis='both', labelsize=18)
            # plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft_switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            # #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/fft_switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            # plt.close()
            ...
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/switch{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/switch{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/cross-corr{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/cross-corr{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
            ...
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/cross-corr-comparison{:>d}_{:>d}_{:>d}.png'.format(d,j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/cross-corr-comparison{:>d}_{:>d}_{:>d}.eps'.format(d,j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
...
def PlotTHSGoFs(model,realXC):
    ...
    for j in range(realX.shape[2]):
        for k in range(10):
            ...
            plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/gof_{:>d}_{:>d}.png'.format(j,i),bbox_inches = 'tight')
            #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/gof_{:>d}_{:>d}.eps'.format(j,i),bbox_inches = 'tight',dpi=200)
            plt.close()
...
def PlotEGPGgrid(col_x,col_y,col_k,i,df,k_is_color=False, scatter_alpha=.7):
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/Gz(Fx(X))_gofs_{:>d}.png'.format(i),bbox_inches = 'tight')
    #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/Gz(Fx(X))_gofs_{:>d}.eps'.format(i),bbox_inches = 'tight',dpi=200)
    plt.close()
...
def PlotBatchGoFs(model,Xtrn,Xvld,i):
    ...
    egpg_df.to_csv('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/EG_PG_{:>d}.csv'.format(i), index= True)
...
def PlotClassificationMetrics(model,realXC):
    ...
    df.to_csv('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/Classification Report C.csv', index= True)
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/classification_report_fakeC.png',bbox_inches = 'tight')
    #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/classification_report.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/confusion_matrix_fakeC.png',bbox_inches = 'tight')
    #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/confusion_matrixC.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    report = classification_report(y_true = labels_real, y_pred = labels_rec,
            target_names=target_names,output_dict=True,zero_division=1)
    df = pd.DataFrame(report).transpose()
    df.to_csv('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/Classification Report recC.csv', index= True)
    cr = sn.heatmap(pd.DataFrame(report).iloc[:-1, :].T, annot=True, vmin=0, vmax=1, annot_kws={"size": 12})
    cr.tick_params(axis='both', labelsize=12)
    cr.set_yticklabels(cr.get_yticklabels(), rotation=0)
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/classification_report_recC.png',bbox_inches = 'tight')
    #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/classification_reportrec.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
    ...
    plt.ylabel("True class",fontsize=22,labelpad=10)
    plt.xlabel("Predicted class",fontsize=22,labelpad=10)
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/confusion_matrix_recC.png',bbox_inches = 'tight')
    #plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/confusion_matrixrecC.eps',bbox_inches = 'tight',dpi=200)
    plt.close()
...
def PlotLatentSpace(model,realXC):
    ...
    fig.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/s_all.png')
    ...
    for n_i in range(1):
        ...
        fig.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/n_{:>d}_{:>d}'.format(n_i,n_i+1),dpi=300,bbox_inches = 'tight')
        plt.clf()
    ...
    for s_i in range(1):
        ...
        fig.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/s_{:>d}_{:>d}'.format(s_i,s_i+1),dpi=300,bbox_inches = 'tight')
        plt.clf()
...
def PlotTSNE(model,realXC):
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/tsne_N.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/tsne_S.png',bbox_inches = 'tight')
    plt.close()
...
def PlotChangeS(model,realXC):
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/ChangeS_tsne_N.png',bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/ChangeS_tsne_S.png',bbox_inches = 'tight')
    plt.close()
...
def PlotDistributions(model,realXC):
    ...
    for i in range(realS.shape[1]):
        ...
        plt.ylabel("Density")
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/distribution_S_{:>d}.png'.format(i),bbox_inches = 'tight')
        plt.close()
    ...
    for i in range(realN.shape[1]):
        ...
        plt.ylabel("Density")
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results_prova/distribution_N_{:>d}.png'.format(i),bbox_inches = 'tight')
        plt.close()
...
GiorgiaGAN.Fx = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Fx",compile=False)
GiorgiaGAN.Gz = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Gz",compile=False)
GiorgiaGAN.Dx = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Dx",compile=False)
GiorgiaGAN.Ds = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Ds",compile=False)
GiorgiaGAN.Dn = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Dn",compile=False)
GiorgiaGAN.Dc = keras.models.load_model("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_prova/25_04/Dc",compile=False)
