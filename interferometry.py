...
def deconvolution(realX_u,realX_d,fakeX_new,d):
    ...
    for i in range(realX_u.shape[2]):
        for k in range(realX_u.shape[2]):
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF_u{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), IRF_u['IRF_u_%d' % i][:,:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF_s{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), IRF_s['IRF_s_%d' % i][:,:,k], delimiter=",")
    ...
    #     plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF{:>d} Floor_real_{:>d}.png'.format(d,i),bbox_inches = 'tight')
    #     plt.close()
    ...
    #     fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
    #     fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
    #     plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF{:>d} Floor_switch_{:>d}.png'.format(d,i),bbox_inches = 'tight')
    #     plt.close()
    ...
    for q in range(10):
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF{:>d}_undamaged_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF{:>d}_switched_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
        ...
        for k in range(realX_u.shape[2]-1,-1,-1):
            ...
            if k==(realX_u.shape[2]-1):
                for spine in ['bottom']:
                    axs[realX_u.shape[2]-1-k].spines[spine].set_visible(False)
                    axs[realX_u.shape[2]-1-k].legend([r'$Undamaged$', r"$ Reconstructed \hspace{0.5} Switched$"],frameon=False,loc='upper right')
            if k==(0):
                for spine in ['top']:
                    axs[realX_u.shape[2]-1-k].spines[spine].set_visible(False)
            if k!=0 and k!=(realX_u.shape[2]-1):
        ...
        fig.text(0.5,0.05,'Time [s]', ha='center', va='center')
        fig.text(0.05,0.5,'Floor level', ha='center', va='center', rotation='vertical')
        plt.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/IRF{:>d}_comparison_{:>d}.png'.format(d,j),bbox_inches = 'tight')
        plt.close()
    ...
    for i in range(realX_u.shape[2]):
        for k in range(realX_u.shape[2]):
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results/dv_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), dv['dv_%d' % i][:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results/cc_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), cc['cc_%d' % i][:,k], delimiter=",")
            np.savetxt("/gpfs/workdir/invsem07/GiorgiaGAN/results/error_{:>d}_floor{:>d}_{:>d}.csv".format(d,i,k), error['error_%d' % i][:,k], delimiter=",")
    ...
    for i in range(realX_u.shape[2]):
        ...
        fig.savefig('/gpfs/workdir/invsem07/GiorgiaGAN/results/stretching_{:>d}_{:>d}.png'.format(d,i), dpi=100)
        plt.close(fig)
