...
def ParseOptions():
    ...
    parser.add_argument("--latentNdim",type=int,default=256,help="Latent space n dimension")
...
class RepGAN(Model):
    ...
    def DumpModels(self):
        self.Fx.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Fx",save_format="tf")
        self.Gz.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Gz",save_format="tf")
        self.Dx.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Dx",save_format="tf")
        self.Ds.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Ds",save_format="tf")
        self.Dn.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Dn",save_format="tf")
        self.Dc.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Dc",save_format="tf")
        self.Q.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Q",save_format="tf")
        self.Gq.save("/gpfs/workdir/invsem07/GiorgiaGAN/checkpoint_skip/21_04/Gq",save_format="tf")
        return
